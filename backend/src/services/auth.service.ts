...
export class AuthService implements IAuthService {
    ...
    async googleOAuth(req: express.Request<Record<string, unknown>, Record<string, unknown>, core.GoogleOAuthRequest>, res: express.Response): Promise<db.user.Schema> {
    ...
    loginWithCookie(res: express.Response, userId: db.user.Document['id']): void {
